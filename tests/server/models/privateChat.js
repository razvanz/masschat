...
describe('PrivateChat preconditions', function () {
	...
	describe("PrivateChat Model", function () {
		...
		it('should query all the private chats based on criterias', function (done) {
		...
		it('should throw error if trying to insert a private chat without 2 users', function (done) {
			var anotherChat = {
				users: [],
				messages: [],
			}
		...
		it('should throw error if trying to update a non-existing private chat', function (done) {
			PrivateChat.update({
				chatname: 'not_there'
			}, {}, function (err, chat) {
				expect(chat)
		...
		it('should throw error if trying to remove a non-existing private chat', function (done) {
			PrivateChat.remove({
				chatname: 'not_there'
			}, function (err, chat) {
				expect(err)
		...
		describe('Aditional functionality', function () {
			...
			it('should retrieve latest n messages from a private chat', function (done) {
				var messages = [],
					lastTmstp, n = 5;
				for (var i = 10; i > 0; i--) {
					lastTmstp = new Date()
			...
			it('should retrieve latest n messages before timestamp from a private chat', function (done) {
				var messages = [],
