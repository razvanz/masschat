...
var PrivateChat = mongoose.models['PrivateChat'] || mongoose.model('PrivateChat', PrivateChatSchema);
...
exports.markMsgSeen = function (chatId, tmstp, userId, callback) {
	...
	return PrivateChat.findOne({
		...
		var updated = 0;
		for (var i = 0, j = chat.messages.length; i < j && chat.messages[i].timestamp.getTime() < tmstp; i++) {
